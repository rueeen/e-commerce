...
class PurchaseOrder(models.Model):
    ...
    original_currency = models.CharField(max_length=3, choices=(("CLP", "CLP"), ("USD", "USD")), default="CLP")
    exchange_rate_to_clp = models.DecimalField(max_digits=12, decimal_places=2, default=1)
    subtotal_original = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    shipping_original = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    sales_tax_original = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    import_duties_original = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    customs_fee_original = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    handling_fee_original = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    paypal_variation_original = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    other_costs_original = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    total_original = models.DecimalField(max_digits=12, decimal_places=2, default=0)
...
class PurchaseOrderItem(models.Model):
    ...
    product = models.ForeignKey(Product, on_delete=models.PROTECT, related_name="purchase_order_items", null=True, blank=True)
    ...
    quantity_ordered = models.PositiveIntegerField(validators=[MinValueValidator(1)], default=1)
    quantity_received = models.PositiveIntegerField(default=0)
    unit_price_original = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    line_total_original = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    unit_price_clp = models.PositiveIntegerField(default=0)
    ...
    margin_percent = models.DecimalField(max_digits=6, decimal_places=2, default=35)
